...
public class MyShader extends BaseShader {
    ...
    public static class Setters {
        public final static Setter projTrans = new BaseShader.GlobalSetter() {
            @Override
...
//            @Override
//            public void set(MyShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
...
//
    public MyShader(final Renderable renderable, final Config config) {
        this(renderable, config, "", config.vertexShader, config.fragmentShader);
    }
...
//    }
    ...
    public MyShader(final Renderable renderable, final Config config, final String prefix, final String vertexShader,
                    final String fragmentShader) {
        this(renderable, config, new ShaderProgram(prefix + vertexShader, prefix + fragmentShader));
    }

    public MyShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
...
//    public static String createPrefix(final Renderable renderable, final MyShader.Config config) {
//        final Attributes attributes = combineAttributes(renderable);
...
//    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof MyShader) && equals((MyShader) obj);
    }

    public boolean equals(MyShader obj) {
        return (obj == this);
    }
